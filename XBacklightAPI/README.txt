...
minumum number to a set maximum number. There is currently no support for
identifying minimum and maximum values, although it would be a simple patch
because that code exists on the original codebase. This code was written for a
project that never got written, but it took me long enough that I'd rather
